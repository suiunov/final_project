...
def main():
    # Hyperparameters
    train_low = '../TensorFlow/data/LOLv1/Train/input'
    train_high = '../TensorFlow/data/LOLv1/Train/target'
    test_low = '../TensorFlow/data/LOLv1/Test/input'
    test_high = '../TensorFlow/data/LOLv1/Test/target'
    learning_rate = 2e-4 
    num_epochs = 200
    ...
    for epoch in range(num_epochs):
        ...
        if avg_psnr > best_psnr:
            ...
            torch.save(model.state_dict(), 'best_model_200epochs.pth')
